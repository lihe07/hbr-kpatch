...
multiple_damage_boost:
  ...
  strb wzr, [x1, #0x98] // <isPoison>k__BackingField
  strb wzr, [x1, #0x99] // <isCriticalHit>k__BackingField
  ...
  ldr w2, [x1, #0x1c] // <spDamage>k__BackingField
  lsl w2, w2, #4
  str w2, [x1, #0x1c]
  ldr w2, [x1, #0x20] // <spDamageForLabel>k__BackingField
  lsl w2, w2, #4
  str w2, [x1, #0x20]
  ldr w2, [x1, #0x28] // <epDamage>k__BackingField
  lsl w2, w2, #4
  str w2, [x1, #0x28]
  ldr w2, [x1, #0x2c] // <epDamageForLabel>k__BackingField
  lsl w2, w2, #4
  str w2, [x1, #0x2c]

  // I will never miss
  strb wzr, [x1, #0x9a] // <isMiss>k__BackingField
  strb wzr, [x1, #0x9b] // <isResist>k__BackingField
  strb wzr, [x1, #0x9e] // <isDodge>k__BackingField

  // I will make critical hit
  mov w2, #1
  strb w2, [x1, #0x99] // <isCriticalHit>k__BackingField
